    ...
    const accountStats =
      filteredTransactions.reduce(
        (acc: any, t: any) => {
          ...
          if (t.type === 'receita') {
            acc[t.category].income +=
              t.amount;
          } else {
            acc[t.category].expense +=
              t.amount;
          }

          acc[t.category].balance =
            acc[t.category].income -
            acc[t.category].expense;
    ...
    <div className="space-y-6 pb-24 animate-in fade-in">
      ...
      <div className="bg-white dark:bg-zinc-900 p-6 rounded-[35px] shadow-sm space-y-4 no-print border dark:border-zinc-800">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="p-2 bg-zinc-100 dark:bg-zinc-800 rounded-xl text-zinc-500 hover:text-red-700 transition-colors"
          >
            <Settings size={18}/>
          </button>
          ...
          <div className="p-4 bg-zinc-50 dark:bg-zinc-800 rounded-3xl border-2 border-dashed border-zinc-200">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {categories.map(
                ...
                <span
                  key={c}
                  className="bg-white dark:bg-zinc-900 px-3 py-1 rounded-full text-[9px] font-black border uppercase flex items-center gap-2 dark:text-zinc-300"
                >
      ...
      <div className="flex gap-2">
        ...
        <input
          type="number"
          placeholder="R$ 0,00"
          className="flex-1 min-w-0 p-4 rounded-2xl bg-gray-50 dark:bg-zinc-800 border-none text-sm font-black text-zinc-900 dark:text-white outline-none"
        ...
        <select
          className="flex-1 min-w-0 p-4 rounded-2xl bg-gray-50 dark:bg-zinc-800 text-xs font-bold text-zinc-500 border-none outline-none"
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-[35px] overflow-hidden shadow-sm border dark:border-zinc-800">
        ...
        <div className="divide-y dark:divide-zinc-800">
          ...
          {filteredTransactions.length === 0 && (
            ...
            <div className="p-10 text-center text-zinc-400 text-[10px] font-black uppercase tracking-widest italic">
